...
alter table BUCHUNG
   add constraint FK_BUCHUNG_GEHOERT_Z_ABFLUG foreign key (KENNZEICHEN, FLUGNR, DATUM)
      references ABFLUG (KENNZEICHEN, FLUGNR, DATUM)
      on delete restrict on update restrict;
